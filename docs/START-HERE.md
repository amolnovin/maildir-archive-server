...
## گام A2 — بکاپ را اکسترکت کنید

بکاپ دایرکت‌ادمین معمولاً چیزی شبیه این است:

```
user.admin.komajsaba.tar.gz
```

آن را با **7-Zip** یا **WinRAR** اکسترکت کنید. توجه: فایل‌های `tar.gz`
دو لایه هستند، پس باید **دو بار** اکسترکت کنید تا به این ساختار برسید:
...
- مسیر را تایپ یا paste کنید: `D:\backup\extracted`
- یا **پوشه را بکشید و روی پنجرهٔ CMD رها کنید** (ساده‌تر)
